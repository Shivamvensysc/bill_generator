...
export const generateBillPDF = async (
  ...
  // Use API response values if available, otherwise calculate locally
  const gstTotal = gstDetail?.cgst && gstDetail?.sgst 
    ? gstDetail.cgst + gstDetail.sgst 
    : (gstDetail?.igst || 0);
      ...
      <div class="invoice">
            ...
            <div class="logo-area">
              ${
                logoBase64
                  ? `
                <div class="logo-icon-custom">
                  <img src="${logoBase64}" alt="Company Logo" style="width: 56px; height: 56px; object-fit: contain;" />
                </div>
              `
                  : `
                <div class="logo-icon">
          ...
          <div class="bill-to-grid">
            ...
            <div>
              ...
              <div class="invoice-meta">
                ...
                <div class="meta-item"><span class="meta-label">Due Date</span><span class="meta-value">${dueDate}</span></div>
                <div class="meta-item"><span class="meta-label">Payment Terms</span><span class="meta-value">15 Days</span></div>
                ${vendor.stateCode ? `<div class="meta-item"><span class="meta-label">Place of Supply</span><span class="meta-value">${vendor.stateCode}</span></div>` : ""}
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="bank-section">
          ...
          <div class="bank-grid">
            ...
            <div class="bank-item">
              <span class="bank-item-label">Account Number</span>
              <span class="bank-item-value">${vendor.bankDetails.accountNumber}</span>
            </div>
            ` : ''}
            ${vendor.bankDetails?.ifscCode ? `
            <div class="bank-item">
              <span class="bank-item-label">IFSC Code</span>
              <span class="bank-item-value">${vendor.bankDetails.ifscCode}</span>
            </div>
            ` : ''}
          </div>
        </div>
        ...
        <div class="footer">
          <div class="signature-row">
            <div class="signature-box">
              <div class="signature-line"></div>
              <div class="signature-label">For ${companyDetails.name}</div>
              <div class="signature-label">Authorized Signatory</div>
            </div>
            <div class="signature-box">
              <div class="signature-line"></div>
